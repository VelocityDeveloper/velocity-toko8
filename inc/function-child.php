...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko8', [
            'priority'    => 10,
            'title'       => esc_html__('Toko 8', 'justg'),
        ...
        new \Kirki\Field\Color(
            [
                'settings'    => 'warna_header',
                'label'       => __('Background Color Heder', 'justg'),
                'description' => esc_html__('', 'justg'),
        ...
        ///Section Banner Single Produk
        Kirki::add_section('section_banner', [
            'panel'    => 'panel_toko8',
            'title'    => __('Banner Single', 'justg'),
            'priority' => 10,
        ]);
        new \Kirki\Field\Image(
            [
                'settings'    => 'banner_single',
                'label'       => esc_html__('Banner Single Produk', 'justg'),
                'description' => esc_html__('Akan muncul di single produk.', 'justg'),
        ...
        ///Section Open Store
        Kirki::add_section('section_open', [
            'panel'    => 'panel_toko8',
            'title'    => __('Open Store', 'justg'),
            'priority' => 10,
        ]);
        new \Kirki\Field\Text(
            [
                'settings' => 'open_store',
                'label'    => esc_html__('Open Store', 'justg'),
                'section'  => 'section_open',
                'default'  => esc_html__('Senin - Sabtu, Jam 07.00 - 15.30, Tanggal Merah Libur', 'justg'),
                'description'  => esc_html__('Ketengan Buka Toko', 'justg'),
                'priority' => 10,
            ]
        );
...
add_action('justg_header', 'justg_header_toko8');
function justg_header_toko8()
{
    require_once(get_stylesheet_directory() . '/inc/part-headertop.php');
    require_once(get_stylesheet_directory() . '/inc/part-header.php');
}
add_action('justg_do_footer', 'justg_footer_toko8');
function justg_footer_toko8()
{
...
{
    echo '<div class="px-2">';
    echo '<div class="card rounded-0 border-0 p-3 container mx-auto">';
}
...
add_action('velocitytoko_product_loop', 'velocitytoko8_content_product', 30);
function velocitytoko8_content_product($post)
{
    ?>
    <article <?php post_class('col-xl-4 col-md-4 col-6 mb-2'); ?> id="post-<?php the_ID(); ?>">
        <div class="card h-100 card-product rounded-0 border-0 overflow-hidden">
